...
form.addEventListener( 'submit' , (e) => {
    ...
    if(donustipi[0].checked == false && donustipi[1].checked == false && donustipi[2].checked == false && kontrol == 0){
        alert('Donüş tipi seçilmedi. Seçmezseniz dönüş yapılmayacaktır. Dönüş istemiyorsanız GÖNDER butonuna tekrar basın.');
        e.preventDefault();
        kontrol++;
    }
